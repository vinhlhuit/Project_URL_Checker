...
public class SiteInfo {
	...
	public Categories categories; // contain information about categories received from WOT
	
	// flag check if result contain zero/ four
	private boolean zero = false;
	private boolean four = false;

	private int trustworthiness_stt = -1; // value of reputation of trustworthiness if it good
	...
	private void get_zero_and_four() {
	...
	public void handle_result_zero_four() {
		// call method handle_zero_and_four() to get reputation and confidence of two component trustworthiness and child safety
		this.get_zero_and_four();
		// set type of site depend on value of reputation and confidence of site, with confidence value is greater than 10
		if (this.getZero()) {
